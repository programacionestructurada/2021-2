...
int main(){
 ...
 print_array(arr,((sizeof(arr))/(sizeof(arr[0]))));printf("\n");
 burbuja(arr,((sizeof(arr))/(sizeof(arr[0]))),0);printf("\n");
 print_array(arr,((sizeof(arr))/(sizeof(arr[0]))));printf("\n");


 print_array(ga,((sizeof(ga))/(sizeof(ga[0]))));printf("\n");
 burbuja(ga,((sizeof(ga))/(sizeof(ga[0]))),0);printf("\n");
 print_array(ga,((sizeof(ga))/(sizeof(ga[0]))));printf("\n");

 print_array(arr,((sizeof(arr))/(sizeof(arr[0]))));printf("\n");
 burbuja(arr,((sizeof(arr))/(sizeof(arr[0]))),1);printf("\n");
 print_array(arr,((sizeof(arr))/(sizeof(arr[0]))));printf("\n");
 return 0;
}
