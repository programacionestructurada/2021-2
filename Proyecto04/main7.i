...
# 5 "main7.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/6/include/stdalign.h" 1 3 4
# 6 "main7.c" 2
...
_Static_assert
# 18 "main7.c"
            (_Alignof(arr) == 4,"unexpected alignment");
...
_Bool 
# 57 "main7.c"
    safediv(int dividend,int divisor,int *quotient)
{
 if (!quotient) return 
# 59 "main7.c" 3 4
                      0
...
int main()
{
 ...
 if (safediv(A,B,&R))
   printf("%d/%d=%d\n",A,B,R);
 printf("/-------------/\n%5u%5u\n",
        (sizeof(str)/sizeof(str[0])),(sizeof(prefix)/sizeof(prefix[0]))+7);
 
# 98 "main7.c" 3 4
_Static_assert
# 98 "main7.c"
             (sizeof(str) >= sizeof(prefix)+7,
...
# 126 "main7.c" 3 4
, "main7.c", 126, __PRETTY_FUNCTION__))
# 126 "main7.c"
                                 ;
