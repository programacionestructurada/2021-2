...
# 3 "DistribucionBinomial.c" 2



# 5 "DistribucionBinomial.c"
...
int main(){
 ...
 printf("\nCaptura la probabilidad de \\'exito de un ensayo de Bernoulli:");
